...
export const ITEMS = {
  ...
  '聚气丹': { type: 'consumable', price: 24, exp: 45, description: '短时间汇聚灵气，适合突破前服用。' },
  '筑基丹': { type: 'consumable', price: 180, exp: 160, description: '筑基修士梦寐以求的破境丹。' },
  '清心丹': { type: 'consumable', price: 65, heal: 20, description: '压制心魔，恢复神识清明。' },
  '九转金丹': { type: 'consumable', price: 1200, heal: 999, exp: 500, description: '传说能从生死边缘夺回一线天命。' },
...
export const QUESTS = {
  'escape-zhao': { type: 'main', act: 1, title: '柴门之外', target: 1, reward: { exp: 20 }, description: '离开赵府柴房，救下被牵连的林小满。' },
  'meet-elder': { type: 'main', act: 1, title: '醉翁传法', target: 1, reward: { exp: 30 }, description: '接受李老的引气考验。' },
  'outer-trial': { type: 'main', act: 1, title: '外门试炼', target: 3, reward: { exp: 80, items: { '木剑': 1 } }, description: '完成三项外门功课，取得正式弟子身份。' },
  'sect-tournament': { type: 'main', act: 2, title: '宗门大比', target: 3, reward: { exp: 150, items: { '青岚令': 1 } }, description: '在大比中证明自己的道心与实力。' },
  'missing-disciples': { type: 'main', act: 2, title: '后山失踪案', target: 3, reward: { exp: 120 }, description: '调查外门弟子接连失踪的真相。' },
  'secret-jade': { type: 'main', act: 2, title: '残简疑云', target: 2, reward: { exp: 130, items: { '残缺玉简': 1 } }, description: '拼合被抹去的宗门旧史。' },
  'mystic-entry': { type: 'main', act: 3, title: '青岚开境', target: 1, reward: { exp: 160 }, description: '持令进入青岚秘境。' },
  'mystic-core': { type: 'main', act: 3, title: '遗境之心', target: 4, reward: { exp: 260 }, description: '穿越四重遗迹，抵达秘境核心。' },
  'truth-below': { type: 'main', act: 3, title: '石碑真名', target: 2, reward: { exp: 220 }, description: '找出镇压裂隙之人的真实姓名。' },
  'north-defense': { type: 'main', act: 4, title: '北境烽火', target: 5, reward: { exp: 420 }, description: '守住天关，决定俘虏与百姓的命运。' },
  'rift-descent': { type: 'main', act: 4, title: '深入幽冥', target: 3, reward: { exp: 500, items: { '星盘碎片': 1 } }, description: '与宁无妄合作或对抗，进入裂隙底部。' },
  'sect-choice': { type: 'main', act: 4, title: '山门存亡', target: 1, reward: { exp: 380 }, description: '在真相与宗门声名之间作出抉择。' },
  'read-stars': { type: 'main', act: 5, title: '天机照命', target: 3, reward: { exp: 600 }, description: '在星海中重见此生最重的三段因果。' },
  'heart-demon': { type: 'main', act: 5, title: '问心一战', target: 1, reward: { exp: 720 }, description: '承认、斩断或拥抱自己的执念。' },
  'final-tribulation': { type: 'main', act: 5, title: '九重天劫', target: 9, reward: { exp: 1000 }, description: '渡过九重雷劫，为此世写下结局。' },
  'herb-basket': { type: 'side', act: 1, title: '小满的药篮', target: 4, reward: { gold: 25, relationship: { '林小满': 6 } }, description: '替林小满收集四株止血草。' },
  'elder-wine': { type: 'side', act: 2, title: '桃花一壶', target: 1, reward: { exp: 40, relationship: { '李老': 8 } }, description: '给李老带一壶真正的桃花酿。' },
  ...
  'broken-promise': { type: 'side', act: 5, title: '旧约未冷', target: 1, reward: { exp: 300 }, description: '在渡劫前履行一个曾经许下的承诺。' },
...
export const RANDOM_EVENTS = [
  ...
  { id: 'rain-meditation', locations: ['落霞宗外门'], text: '一场灵雨洗过山门，你忽然听懂了雨落石阶的节奏。', effect: { exp: 18 } },
  { id: 'broom-sword', locations: ['落霞宗外门'], text: '扫地弟子用竹帚比了一个剑势，竟让你心头一震。', effect: { exp: 16 } },
  { id: 'cherry-letter', locations: ['后山樱林'], text: '花瓣托着一行无人署名的小字：莫忘来路。', effect: { exp: 12 } },
  { id: 'sleeping-fox', locations: ['后山樱林'], text: '一只灵狐枕着你的衣角睡着了，怎么也不肯挪窝。', effect: { mercy: 1 } },
  { id: 'elder-snore', locations: ['后山樱林'], text: '李老的呼噜震落满树花瓣，其中一瓣竟蕴着剑意。', effect: { exp: 25 } },
  ...
  { id: 'warm-cauldron', locations: ['丹霞谷'], text: '废弃丹炉仍有余温，炉底凝着一滴药露。', effect: { exp: 22 } },
  { id: 'herb-argument', locations: ['丹霞谷'], text: '两株灵草为了谁先开花吵得不可开交。', effect: { exp: 10 } },
  { id: 'small-explosion', locations: ['丹霞谷'], text: '隔壁丹房轰然一响，苏晚晴面无表情地递来扫帚。', effect: { mercy: 1 } },
  { id: 'nameless-sword', locations: ['古剑冢'], text: '一柄无名残剑跟了你三步，又悄悄插回土里。', effect: { exp: 28 } },
  { id: 'sword-rain', locations: ['古剑冢'], text: '万剑同时低鸣，像在为某个旧人送行。', effect: { exp: 30 } },
  { id: 'snow-blossom', locations: ['古剑冢'], text: '慕容雪挥剑削下一片石花，落地前便碎成霜。', effect: { ambition: 1 } },
  { id: 'fog-loop', locations: ['青岚秘境'], text: '你第三次路过同一块会骂人的石头，它终于肯指路。', effect: { exp: 35 } },
  ...
  { id: 'old-chain', locations: ['幽冥裂隙'], text: '锈链上刻着落霞宗初代祖师的名字。', effect: { exp: 48 } },
  { id: 'shadow-bargain', locations: ['幽冥裂隙'], text: '影子提出替你承担一次伤痛，代价是记住它。', effect: { demonic: 1 } },
  { id: 'falling-star', locations: ['天机台'], text: '一颗星从命盘滑落，却在掌心化作温热微光。', effect: { exp: 60 } },
  ...
  { id: 'silent-thunder', locations: ['飞升台'], text: '雷云无声翻涌，天地在等你先开口。', effect: { exp: 80 } }
];

export const ENEMIES = {
  'spirit-rat': { name: '偷粮灵鼠', realm: 0, hp: 28, attack: 6, defense: 1, exp: 18, gold: 5 },
  'zhao-guard': { name: '赵府恶仆', realm: 0, hp: 42, attack: 8, defense: 2, exp: 24, gold: 9 },
  'mountain-wolf': { name: '青背山狼', realm: 1, hp: 58, attack: 11, defense: 3, exp: 34, gold: 7 },
  'rogue-cultivator': { name: '劫道散修', realm: 2, hp: 76, attack: 15, defense: 5, exp: 46, gold: 24 },
  'wood-puppet': { name: '试炼木傀', realm: 3, hp: 92, attack: 17, defense: 8, exp: 58, gold: 0 },
  'poison-bee': { name: '赤尾毒蜂', realm: 4, hp: 68, attack: 23, defense: 4, exp: 64, gold: 8 },
  'sword-spirit': { name: '残剑之灵', realm: 6, hp: 130, attack: 30, defense: 12, exp: 96, gold: 0 },
  'inner-rival': { name: '内门骄子', realm: 7, hp: 150, attack: 34, defense: 14, exp: 110, gold: 30 },
  'fog-beast': { name: '青岚雾兽', realm: 9, hp: 210, attack: 42, defense: 18, exp: 150, gold: 40 },
  'stone-keeper': { name: '遗迹石将', realm: 10, hp: 270, attack: 48, defense: 24, exp: 190, gold: 0 },
  'mirror-self': { name: '镜中之我', realm: 12, hp: 330, attack: 58, defense: 28, exp: 230, gold: 0 },
  'mystic-devourer': { name: '噬境古兽', realm: 13, hp: 410, attack: 66, defense: 34, exp: 280, gold: 80 },
  'demon-scout': { name: '魔道斥候', realm: 14, hp: 470, attack: 74, defense: 38, exp: 330, gold: 65 },
  'snow-ogre': { name: '踏雪巨魔', realm: 15, hp: 560, attack: 82, defense: 44, exp: 390, gold: 70 },
  'rift-wraith': { name: '裂隙怨魂', realm: 16, hp: 620, attack: 92, defense: 48, exp: 450, gold: 0 },
  'fallen-elder': { name: '堕化长老', realm: 18, hp: 760, attack: 108, defense: 58, exp: 580, gold: 120 },
  'heart-demon': { name: '本我心魔', realm: 20, hp: 920, attack: 126, defense: 68, exp: 720, gold: 0 },
  'heaven-avatar': { name: '天道化身', realm: 22, hp: 1280, attack: 150, defense: 82, exp: 1000, gold: 0 }
};

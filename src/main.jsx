...
function InvitePage({ onJoin }) {
  ...
  return <main className="invite-page"><section className="invite-stage cinematic-invite" aria-label="Chronos invitation"><div className="invite-vault" aria-hidden="true"><i/><i/><i/><i/><i/></div><div className="envelope-wrap"><div className="envelope-shadow"/><div className="envelope"><div className="envelope-back"/><div className="envelope-letter"><span>CHRONOS INVITATION</span><h1>{from} saved a seat for {to}.</h1><p>Step into a calmer way to plan time, meet in private rooms, and see your day with intention.</p></div><div className="envelope-left"/><div className="envelope-right"/><div className="envelope-front"/><div className="envelope-flap"/></div></div><div className="invite-copy"><span>PRIVATE TIME NETWORK</span><h2>Your time. Now in orbit.</h2><p>Create your Chronos account, add your friend, and open a private room when you are ready.</p><button className="gold-button invite-accept" onClick={onJoin}>Accept invitation</button></div></section></main>;
}
